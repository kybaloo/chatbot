...
def test_conversation_service_initialization(
    mock_conversation_repository, mock_ai_service
):
...
def test_get_conversation(
    mock_conversation_repository, mock_ai_service, sample_conversation
):
...
def test_add_user_message_and_get_ai_response(
    mock_conversation_repository, mock_ai_service, sample_conversation
):
    ...
    last_user_message = conversation.messages[
        -2
    ]  # L'avant-dernier message devrait être celui de l'utilisateur
    ...
    last_ai_message = conversation.messages[
        -1
    ]  # Le dernier message devrait être celui de l'IA
...
def test_list_conversations(
    ...
    mock_conversation_repository.list_for_user.assert_called_once_with(
